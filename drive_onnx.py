...
if __name__ == "__main__":
    ...
    # Load imitation model using onnx runtime
    sess = rt.InferenceSession(args.path)
    ...
    while(True):
        ...
        raw_result = sess.run([], {input_name: input_img})
        car_controls.steering = actions[np.argmax(raw_result[0])]
